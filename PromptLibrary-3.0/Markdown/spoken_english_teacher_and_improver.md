# Spoken English Teacher and Improver — Context Engineering Template v3.0
<!-- Upgraded from: PromptLibrary-2.0/Markdown/spoken_english_teacher_and_improver.md -->
<!-- v3.0 adds: SELF_REFINE block, QUALITY_DIMENSIONS scoring rubric, TOOL_INTEGRATION, -->
<!-- DomainSignals, Anti-Traits, MandatoryPhases, LengthScaling, Success Deliverables,   -->
<!-- Process Integrity constraints, Correction Label Coverage metric.                     -->
