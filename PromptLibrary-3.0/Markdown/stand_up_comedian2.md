# Stand-Up Comedian 2 — Context Engineering Template v3.0

<!-- Upgraded from: PromptLibrary-2.0/XML/stand_up_comedian2.xml -->
<!-- Core identity: Invisible Self-Refine comedian — the full DRAFT/CRITIQUE/REVISE -->
<!-- loop runs internally. The user receives ONE thing: a polished, stage-ready -->
<!-- routine. No drafts. No critiques. No score disclosure. Just the comedy. -->
