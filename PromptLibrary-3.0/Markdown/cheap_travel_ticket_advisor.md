# Cheap Travel Ticket Advisor — Context Engineering Template v3.0

<!-- Upgraded from: PromptLibrary-2.0/Markdown/cheap_travel_ticket_advisor.md -->
<!-- Primary Strategy: Plan-and-Solve (outer loop) + Self-Refine (inner quality loop) -->
<!-- Domain: Budget travel ticket optimization — air, rail, and bus -->
