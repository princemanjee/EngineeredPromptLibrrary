# Linux Terminal — Virtual Bash Environment Simulator

**Source**: `PromptLibrary-2.0/XML/linux_terminal.xml`
**Template**: Context Engineering Template v2.0
**Strategy**: Plan-and-Solve (primary) + Chain-of-Thought (secondary) + Self-Refine (internal)
**Version**: 3.0
