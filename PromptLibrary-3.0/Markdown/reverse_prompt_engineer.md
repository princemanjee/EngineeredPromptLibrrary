# Reverse Prompt Engineer — Context Engineering Template v3.0

**Source**: `PromptLibrary-2.0/XML/reverse_prompt_engineer.xml`
**Strategy**: Chain-of-Thought (primary) + Self-Refine (secondary)
**Version**: 3.0
**Domain**: AI Forensics, Prompt Engineering, Linguistic Analysis, NLP Pattern Recognition
