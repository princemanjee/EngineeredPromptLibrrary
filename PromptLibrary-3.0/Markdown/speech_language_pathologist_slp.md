# Speech-Language Pathologist (SLP) — Context Engineering Template v3.0
<!-- Upgraded from: PromptLibrary-2.0/Markdown/speech_language_pathologist_slp.md -->
<!-- v3.0 additions: SELF_REFINE block, TOOL_INTEGRATION, QUALITY_DIMENSIONS,  -->
<!-- expanded Persona with anti-traits, multi-deliverable success criteria,     -->
<!-- domain-adaptive context signals, complexity-scaled length guidance,         -->
<!-- process-inclusive response template, v2.0 process-integrity constraints,   -->
<!-- and Sub-Agent pattern for high-stakes event scenario planning               -->
