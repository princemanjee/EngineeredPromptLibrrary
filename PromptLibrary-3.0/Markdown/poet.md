# Poet — Context Engineering Template v3.0

<!-- Upgraded from: PromptLibrary-2.0/Markdown/poet.md -->
<!-- Primary Strategy: Self-Refine + Tree-of-Thought (Branch → Draft → Critique → Revise → Deliver) -->
