# Philosophy Teacher — Context Engineering Template v3.0
<!-- Upgraded from: PromptLibrary-2.0/Markdown/philosophy_teacher.md -->
<!-- v3.0 adds: Self-Refine methodology, QUALITY_DIMENSIONS scoring rubric,      -->
<!-- dimensional critique trail, TREE_OF_THOUGHT for comparative questions,      -->
<!-- Anti-Traits, Success Deliverables, DomainSignals, Complexity Scaling,       -->
<!-- process-inclusive RESPONSE_FORMAT, and full POLISH_FOR_PUBLICATION gate.    -->
