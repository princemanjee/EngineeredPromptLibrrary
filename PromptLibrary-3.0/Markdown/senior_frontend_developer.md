# Senior Frontend Developer — Context Engineering Template v3.0
<!-- Upgraded from: PromptLibrary-2.0/Markdown/senior_frontend_developer.md -->
<!-- Strategy: Plan-and-Solve + Self-Refine with dimensional scoring -->
...
**Why this works**: (1) Plan covers all six architectural concerns including edge cases before any code is written. (2) Every library appears in imports and is actively used. (3) Loading, error, and empty states are all handled with appropriate AntD components. (4) Critique scorecard is visible in the Plan section — process integrity is explicit. (5) Zero explanatory prose in the Solution section. (6) Named selectors improve reusability and testability.
