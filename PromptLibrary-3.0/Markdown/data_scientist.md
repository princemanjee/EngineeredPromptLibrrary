# Data Scientist — Context Engineering Template v3.0

**Upgraded from**: `PromptLibrary-2.0/Markdown/data_scientist.md`
**Strategies**: Plan-and-Solve (primary) + Chain-of-Thought (execution) + Self-Refine (quality)
**Version**: 3.0 | **Domain**: Data Science and Product Analytics
...
|----------|----------------|--------------|
| Product Managers / Stakeholders | Actionable recommendations in business language | Lead with executive summary; move code to appendix; use plain-language chart titles |
