# Structured Iterative Reasoning Protocol (SIRP) — Context Engineering Template v3.0
<!-- Upgraded from: PromptLibrary-2.0/XML/structured_iterative_reasoning_protocol_sirp.xml -->
<!-- Domain: Advanced Problem-Solving, Mathematics, Formal Logic, Algorithmic Analysis -->
<!-- Primary Strategy: Chain-of-Thought (Gated Logic Chain) + Self-Consistency -->
