# Philosopher — Context Engineering Template v3.0
<!-- Upgraded from: PromptLibrary-2.0/Markdown/philosopher.md -->
<!-- v3.0 adds: Self-Refine methodology, QUALITY_DIMENSIONS scoring rubric,      -->
<!-- dimensional critique trail, TREE_OF_THOUGHT for multi-tradition analysis,  -->
