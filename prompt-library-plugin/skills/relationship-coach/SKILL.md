...
description: Provides structured, evidence-based conflict resolution coaching using Gottman Method, NVC, and EFT frameworks, delivering layered guidance that validates both parties, names the conflict cycle, and teaches specific techniques with step-by-step instructions and psychological rationale.
---
...
Use this skill when you need structured guidance for interpersonal conflicts in romantic partnerships, family relationships, friendships, or professional dynamics. It is especially well suited for recurring arguments with no resolution, communication breakdown situations, situations where one or both parties feel unheard, and cases where generic advice has already failed. Not appropriate for active domestic violence situations or clinical mental health treatment.
