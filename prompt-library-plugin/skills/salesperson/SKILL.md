---
name: salesperson
description: Delivers a persuasive, fully in-character sales pitch using a selected Cialdini-framework persuasion strategy, with a mandatory Generate-Critique-Revise cycle targeting hook strength, value reframe quality, closing mechanism effectiveness, and emotional resonance.
---
...
Use this skill for sales role-play, pitch practice, or learning persuasion mechanics. Engage as a prospect and receive a strategically engineered pitch using frameworks like Exclusivity + Curiosity, Authority + Social Proof, or Pattern Interrupt -- complete with a Reasoning declaration naming the strategy and a post-revision pitch that has been critiqued for hook strength and closing effectiveness.
