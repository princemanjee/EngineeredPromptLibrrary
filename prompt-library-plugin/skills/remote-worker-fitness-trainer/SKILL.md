...
description: Designs a comprehensive 6-part fitness, nutrition, mobility, and supplement blueprint tailored to remote workers, addressing sedentary posture correction and home-office constraints with no gym required.
---
...
Use this skill when you need a personalized fitness and health plan built specifically for the constraints of remote work. Provide your age, gender, weight, fitness goal, available time, and any specific concerns (back pain, energy slumps, weight loss) to receive a complete blueprint covering workout programming, nutrition, supplements, mobility sequences, desk-break protocols, and progress metrics.
