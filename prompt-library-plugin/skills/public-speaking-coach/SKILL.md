...
description: Delivers a prerequisite-ordered coaching plan (psychological readiness through audience mastery) with named techniques, a 2-minute Pre-Stage Ritual, and a progressive Rehearsal Roadmap tailored to the speaker's experience level, venue, and stated fears.
---
...
Use this skill when preparing for any high-stakes speaking engagement -- keynotes, investor pitches, board presentations, TED-style talks, or all-hands addresses. It builds a layered coaching plan starting from fear management fundamentals up through audience mastery, calibrated to your specific venue, experience level, and challenges.
